...
public class ChaoFrame extends JFrame implements KeyListener, ActionListener {

	public static void main(String[] argv) throws IOException {
		ChaoFrame frame = new ChaoFrame();
	...
	public ChaoFrame() {
		...
		this.addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				ChaoFrame.this.setVisible(false);
			}
		...
		public void actionPerformed(ActionEvent event) {
			try {
				...
				if (filename == null) {
					...
					int result = chooser.showSaveDialog(ChaoFrame.this);
					...
					while (flag
						...
						if (rs == JOptionPane.OK_OPTION)
							...
							result = chooser.showSaveDialog(ChaoFrame.this);
					}
	...
	class OpenAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			int result = chooser.showOpenDialog(ChaoFrame.this);
	 ...
	 * 
	 */
	private JMenu jFileMenu, jEditMenu;
	private JMenuItem saveAsItem, saveItem, createItem, openItem, closeItem,
			auothorItem, cutItem, copyItem, pasteItem;
